...
interface HelloJSUtilities { // Added 
    extend: (par: any, par2: any) => void; // Added
} // Added

interface HelloJSStatic extends HelloJSEvent {
    init(serviceAppIds: { [id: string]: string; }, options?: HelloJSLoginOptions): void;
    login(network: string, options?: HelloJSLoginOptions, callback?: () => void): any; // changed HelloJSStatic to Promise<any>
...
interface HelloJSServiceDef {
    ...
    login?: (par: any) => void; //added
    logout?: (par: any) => void; //added
    base?: string;
    root?: string;
    get?: { [id: string]: any; };
    post?: { [id: string]: any; };
